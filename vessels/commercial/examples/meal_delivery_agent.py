...
using the Vessels commercial agent framework.
"""

from vessels.commercial.agent_builder import CommercialAgentBuilder, CommercialAgentConfig
from vessels.commercial.fee_structure import ProductCategory
...
def create_agent_and_submit_example():
    ...
    """
    from vessels.commercial.registry import CommercialAgentRegistry
