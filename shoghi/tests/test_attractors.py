...
import pytest
import numpy as np
from shoghi.measurement.state import PhaseSpaceState, OperationalState, VirtueState
from shoghi.phase_space.attractors import (
    AttractorDiscovery,
...
class TestAttractorUtilities:
    ...
    def test_find_nearest_attractor(self):
        ...
        from shoghi.phase_space.attractors import Attractor
