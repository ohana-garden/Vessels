---
id: ARCH-001
title: Shoghi System Architecture
author: Stephen
date: 2025-11-11
---
...
Shoghi’s architecture can be visualized as a multi-layer system:
...
- **Infrastructure Layer**: manages deployment, packaging, and runtime environment (Docker, auto_deploy script, start_shoghi.sh). Includes the universal connector, voice interface integration and network resilience.
