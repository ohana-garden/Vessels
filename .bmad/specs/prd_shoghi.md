---
id: PRD-001
title: Shoghi Voice-First Assistant Platform
author: Stephen
date: 2025-11-11
---
...
- Developers and administrators extending Shoghi’s capabilities.
...
8. **Deployment and Scaling** – Run locally via CLI, host via Flask web server and optionally deploy in Docker using `deploy_shoghi.sh`.
