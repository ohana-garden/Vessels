...
Shoghi temporal knowledge graph backed by FalkorDB.
"""
...
class NodeType(str, Enum):
    """Node types in the Shoghi knowledge graph"""
...
class RelationType(str, Enum):
    """Relationship types in the Shoghi knowledge graph"""
...
class ShorghiGraphSchema:
    """
    Comprehensive schema for Shoghi knowledge graph
    ...
    def get_required_properties(node_type: NodeType) -> List[str]:
        ...
        return ShorghiGraphSchema.NODE_SCHEMAS.get(node_type, [])
    ...
    def validate_node_properties(node_type: NodeType, properties: Dict[str, Any]) -> bool:
        ...
        required = ShorghiGraphSchema.get_required_properties(node_type)
