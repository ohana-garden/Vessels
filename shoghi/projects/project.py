...
from shoghi.knowledge import ShorghiGraphitiClient, ProjectVectorStore
from shoghi.knowledge.schema import ServantType, CommunityPrivacy
...
class ServantProject:
    ...
    _graphiti_client: Optional[ShorghiGraphitiClient] = field(default=None, repr=False)
    ...
    @property
    def graphiti(self) -> ShorghiGraphitiClient:
        """Lazy-load Graphiti client"""
        if self._graphiti_client is None:
            self._graphiti_client = ShorghiGraphitiClient(
