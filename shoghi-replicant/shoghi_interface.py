...
"""
SHOGHI INTERFACE
Natural language interface for the Shoghi platform
...
class ShoghiInterface:
    """Natural language interface for Shoghi platform"""
    ...
    def initialize_interface(self):
        ...
        logger.info("Shoghi Natural Language Interface initialized")
    ...
    def _classify_interaction(self, message: str) -> InteractionType:
        ...
        elif message_lower.startswith('shoghi'):
...
"""
    ...
    def _deploy_full_platform(self, interaction: UserInteraction) -> Dict[str, Any]:
        ...
        try:
            ...
            response = f"""
🚀 **Full Shoghi Platform Activated**
...
Shoghi is an adaptive coordination platform that automatically creates and manages agent networks to fulfill community needs.
...
"""
    ...
    def shutdown(self):
        ...
        logger.info("Shoghi Interface shutdown complete")

# Global interface instance
shoghi_interface = ShoghiInterface()

def process_user_message(user_id: str, message: str, context: Dict[str, Any] = None) -> Dict[str, Any]:
    """Main entry point for processing user messages"""
    return shoghi_interface.process_message(user_id, message, context)